...
<x-guest-layout>
    <div class="mb-4 text-sm text-gray-600">
        {{ __('Forgot your password? No problem. Just enter your email address and answer your security question correctly to reset your password — no email verification needed.') }}
    </div>
